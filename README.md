...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pg7lq7m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pg7lq7m.containers.anotherwebservice.com/
...
```
git clone git@github.com:amazingcoder345/container-pg7lq7m.git
cd container-pg7lq7m
```
...
```
docker attach container-pg7lq7m
```
